...
export const TermsOfServiceModal: React.FC<TOSModalProps> = ({
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-slate-950/70 backdrop-blur-sm p-4">
      <div className="bg-white dark:bg-slate-900 rounded-2xl max-w-2xl w-full max-h-[85vh] flex flex-col shadow-2xl border border-slate-100 dark:border-slate-800 overflow-hidden animate-in fade-in zoom-in-95 duration-200 transition-colors">
        {/* Header */}
        <div className="p-5 border-b border-slate-100 dark:border-slate-800 flex items-center justify-between bg-slate-50 dark:bg-slate-850">
          <div className="flex items-center gap-3">
            <div className="w-10 h-10 rounded-xl bg-emerald-100 dark:bg-emerald-950/60 text-[#2E7D32] dark:text-emerald-400 flex items-center justify-center">
              <ShieldCheck className="w-5 h-5" />
            </div>
            <div>
              <h2 className="text-lg font-bold text-slate-800 dark:text-slate-100">Terms of Service & Privacy Policy</h2>
              <p className="text-xs text-slate-500 dark:text-slate-400">Last updated: July 2026</p>
            </div>
          </div>
          <button
            onClick={onClose}
        ...
        <div className="p-6 overflow-y-auto space-y-4 text-sm text-slate-600 dark:text-slate-300 leading-relaxed">
          <div className="p-3 bg-emerald-50 dark:bg-emerald-950/40 rounded-xl border border-emerald-100 dark:border-emerald-800 flex items-start gap-3 text-xs text-emerald-800 dark:text-emerald-300">
          ...
          <h3 className="font-bold text-slate-800 dark:text-slate-100 text-base">1. Account Registration & Roles</h3>
          <p>
          ...
          <h3 className="font-bold text-slate-800 dark:text-slate-100 text-base">2. Booking Requests & Approval Workflow</h3>
          <p>
          ...
          <h3 className="font-bold text-slate-800 dark:text-slate-100 text-base">3. Cancellation & Refund Policy</h3>
          <p>
          ...
          <h3 className="font-bold text-slate-800 dark:text-slate-100 text-base">4. Turf Owner Responsibilities & Media Verification</h3>
          <p>
          ...
          <h3 className="font-bold text-slate-800 dark:text-slate-100 text-base">5. Data Privacy & Encryption</h3>
          <p>
          ...
          <h3 className="font-bold text-slate-800 dark:text-slate-100 text-base">6. Platform Disclaimer & Support Assistance</h3>
          <div className="p-3 bg-amber-50 dark:bg-amber-950/40 rounded-xl border border-amber-200 dark:border-amber-800 text-xs text-amber-900 dark:text-amber-300 leading-relaxed">
        ...
        <div className="p-4 border-t border-slate-100 dark:border-slate-800 bg-slate-50 dark:bg-slate-850 flex items-center justify-end gap-3">
          <button
            onClick={onClose}
            className="px-4 py-2 text-sm font-semibold text-slate-600 dark:text-slate-400 hover:text-slate-800 dark:hover:text-slate-200 hover:bg-slate-200/50 dark:hover:bg-slate-800 rounded-xl transition-colors cursor-pointer"
          >
            Close
          </button>
          {onAccept && (
            <button
              ...
              className="px-5 py-2 text-sm font-semibold text-white bg-[#2E7D32] hover:bg-[#1b4d1f] rounded-xl shadow-md transition-all cursor-pointer"
            >
              I Accept & Agree
            </button>
          )}
