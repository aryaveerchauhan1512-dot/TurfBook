    ...
    <div className="fixed inset-0 z-50 flex justify-end bg-slate-900/50 backdrop-blur-xs">
      <div className="bg-white w-full max-w-md h-full flex flex-col shadow-2xl border-l border-slate-200 animate-in slide-in-from-right duration-200">
        ...
        <div className="p-5 border-b border-slate-100 flex items-center justify-between bg-slate-50">
          <div>
            <h2 className="text-lg font-black text-slate-800">Filter Turfs</h2>
          ...
          <div className="flex items-center gap-2">
            <button
              ...
              className="p-2 text-slate-500 hover:text-slate-800 rounded-lg hover:bg-slate-200/60 text-xs font-semibold flex items-center gap-1 transition-colors"
            >
        ...
        <div className="p-6 overflow-y-auto space-y-6 flex-1 text-slate-800">
          ...
          <div>
            ...
            <div className="relative mb-2">
              ...
              <input
                ...
                className="w-full pl-8 pr-3 py-2 bg-slate-50 border border-slate-200 rounded-xl text-xs text-slate-800 placeholder-slate-400 focus:outline-none focus:ring-2 focus:ring-[#2E7D32]"
              />
            </div>
          ...
          <div>
            ...
            <input
              ...
              className="w-full accent-[#2E7D32] h-2 bg-slate-200 rounded-lg cursor-pointer"
            />
              ...
              {[0, 3.5, 4.0, 4.5].map((r) => (
                <button
                  ...
                  className={`py-2 px-3 rounded-xl border text-xs font-bold flex items-center justify-center gap-1 transition-all ${
                    filters.minRating === r
                      ? 'bg-emerald-50 border-[#2E7D32] text-[#2E7D32] shadow-sm'
